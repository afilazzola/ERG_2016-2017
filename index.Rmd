...
m2.l <- glmer(presence~Microsite * poly(arid.gradient,2) * Nutrient + (1|Year),data=subset(census.long, species=="P. insularis"), family=poisson)
car::Anova(m2.l)

m2 <- lmer(log(Plantago.biomass)~Microsite * arid.gradient * Nutrient + (1|Year), data=subset(census.arid, Plantago.biomass>0))
...
library(effects)
epha <- as.data.frame(Effect(c("arid.gradient","Microsite"),m1))
epla <- as.data.frame(Effect(c("arid.gradient","Microsite"),m2))
esal <- as.data.frame(Effect(c("arid.gradient","Microsite"),m3))
ee <- rbind(epha,epla, esal)
ee[,"species"] <- rep(c("phacelia","plantago","salvia"),each=5)
#ee[,2:5] <- exp(ee[,2:5])


ggplot()+ geom_jitter(aes(x=arid.gradient, y=log(biomass), fill=species, colour=species),alpha=0.6, width = 0.05, data=subset(census.long, biomass>0)) +geom_line(data=ee, aes(arid.gradient,fit,colour=species,fill=species),lwd=1.4)
...
m1 <- lmer(ihs(bio)~Microsite * poly(arid.gradient,3) + (1|Year), data=mean.year)
shapiro.test(resid(m1))
anova(m1)
r.squaredGLMM(m1) ## R squared values 
...
m3 <- lmer(rich~Microsite * poly(arid.gradient,2) + (1|Year), data=mean.year)
shapiro.test(resid(m3))
anova(m3)
r.squaredGLMM(m3) ## R squared values 

m4 <- lmer(mpd~Microsite * arid.gradient + (1|Year), data=mpd.arid)
shapiro.test(resid(m3))
anova(m3)
r.squaredGLMM(m3) ## R squared values 

### Biomass
p1 <- ggplot(mean.year) + geom_jitter(aes(x=arid.gradient, y=ihs(bio)), color="#56B4E9", size=3, data=subset(mean.year, Microsite=="shrub")) +geom_jitter(aes(x=arid.gradient, y=ihs(bio)), color="#E69F00", size=3, data=subset(mean.year, Microsite=="open"))  + theme_Publication()+ stat_smooth(method="lm", formula= y~poly(x,3),aes(x=arid.gradient, y=ihs(bio)), color="#E69F00", fill="#E69F0080", data=subset(mean.year, Microsite=="open"), lwd=1.4) +  stat_smooth(method="lm", formula= y~poly(x,3),aes(x=arid.gradient, y=ihs(bio)), color="#56B4E9", fill="#56B4E970", data=subset(mean.year, Microsite=="shrub"), lwd=1.4)  + ylab("Annnual plant biomass")+ xlab("") + annotate("text", x=-4.5,y=4, label="a", size=8)+coord_cartesian(ylim=c(0, 4))

### abundance
p2 <- ggplot(mean.year) + geom_jitter(aes(x=arid.gradient, y=ihs(abd)), color="#56B4E9", size=3, data=subset(mean.year, Microsite=="shrub")) +geom_jitter(aes(x=arid.gradient, y=ihs(abd)), color="#E69F00", size=3, data=subset(mean.year, Microsite=="open"))  + theme_Publication()+  stat_smooth(method="lm", formula= ihs(y)~x,aes(x=arid.gradient, y=abd), color="black", fill="Grey50", data=mean.year, lwd=1.4)+ ylab("Annual plant abundance")+ xlab("")+ annotate("text", x=-4.5,y=6, label="b", size=8)

### richness
p3 <- ggplot(mean.year) + geom_jitter(aes(x=arid.gradient, y=rich), color="#56B4E9", size=3, data=subset(mean.year, Microsite=="shrub")) +geom_jitter(aes(x=arid.gradient, y=rich), color="#E69F00", size=3, data=subset(mean.year, Microsite=="open"))  + theme_Publication()+ stat_smooth(method="lm", formula= y~poly(x,2),aes(x=arid.gradient, y=rich), color="#E69F00", fill="#E69F0080", data=subset(mean.year, Microsite=="open"), lwd=1.4) +  stat_smooth(method="lm", formula= y~poly(x,2),aes(x=arid.gradient, y=rich), color="#56B4E9", fill="#56B4E970", data=subset(mean.year, Microsite=="shrub"), lwd=1.4)  + ylab("Species richness") + xlab("Aridity Gradient")+ annotate("text", x=-4.5,y=4, label="c", size=8)

### phylogenetic diveristy
p4 <- ggplot(mpd.arid)+ geom_jitter(aes(x=arid.gradient, y=mpd), color="#56B4E9", size=3, data=subset(mpd.arid, Microsite=="shrub")) +geom_jitter(aes(x=arid.gradient, y=mpd), color="#E69F00", size=3, data=subset(mpd.arid, Microsite=="open"))  +  stat_smooth(method="lm", formula= y~x,aes(x=arid.gradient, y=mpd), data=subset(mpd.arid, Microsite=="shrub"), color="#56B4E9",fill="#56B4E980", lwd=1.4)+  stat_smooth(method="lm", formula= y~x,aes(x=arid.gradient, y=mpd), data=subset(mpd.arid, Microsite=="open"), color="#E69F00",fill="#E69F0080", lwd=1.4)+ ylab("Phylogenetic Community Dissimilarity") + xlab("Aridity Gradient")+ theme_Publication()+ annotate("text", x=-4.5,y=1.8, label="d", size=8)
...
## nitrogen
m5 <- lm(nitrogen ~ arid.gradient, data=subset(nutrient.mean, microsite=="open"))
summary(m5)
anova(m5)
r.squaredGLMM(m5) ## R squared values 

p5 <- ggplot(nutrient.mean) + geom_jitter(aes(x=arid.gradient, y=nitrogen), color="#56B4E9", size=3, data=subset(nutrient.mean, microsite=="shrub"))+ geom_jitter(aes(x=arid.gradient, y=nitrogen), color="#E69F00", size=3, data=subset(nutrient.mean, microsite=="open"))+  stat_smooth(method="lm", formula= y~x,aes(x=arid.gradient, y=nitrogen), color="#56B4E9", fill="#56B4E980", data=subset(nutrient.mean, microsite=="shrub"), lwd=1.4) +  
  stat_smooth(method="lm", formula= y~x,aes(x=arid.gradient, y=nitrogen), color="#E69F00", fill="#E69F0080",data=subset(nutrient.mean, microsite=="open"), lwd=1.4)+ ylab("Nitrogen (ppm)") + xlab("")+ theme_Publication()+ annotate("text", x=-4.5,y=32, label="a", size=8)+coord_cartesian(ylim=c(0, 32))
...
m6 <- lmer(swc.avg~Microsite * poly(arid.gradient,2) + (1|Year), data=smc.early)
...
p6 <- ggplot(smc.early) + geom_jitter(aes(x=arid.gradient, y=swc.avg), color="#56B4E9", size=3, data=subset(smc.early, Microsite=="shrub")) +geom_jitter(aes(x=arid.gradient, y=swc.avg), color="#E69F00", size=3, data=subset(smc.early, Microsite=="open"))  + theme_Publication()+ stat_smooth(method="lm", formula= y~poly(x,2),aes(x=arid.gradient, y=swc.avg), data=smc.early, lwd=1.4, color="black") + ylab("Soil moisture at emergence (%)") + xlab("Aridity Gradient")+ annotate("text", x=-4.5,y=30, label="c", size=8)
...
## temperature variability
m7 <- lmer(temp.var.x~Microsite * poly(arid.gradient,2) + (1|Year), data=hobo.arid)
shapiro.test(resid(m7))
anova(m7)
r.squaredGLMM(m7) ## R squared values 


p7 <- ggplot(hobo.arid) + geom_jitter(aes(x=arid.gradient, y=temp.var.x), color="#56B4E9", size=3, data=subset(hobo.arid, Microsite=="shrub")) +geom_jitter(aes(x=arid.gradient, y=temp.var.x), color="#E69F00", size=3, data=subset(hobo.arid, Microsite=="open"))  + theme_Publication()+ stat_smooth(method="lm", formula= y~poly(x,2),aes(x=arid.gradient, y=temp.var.x), color="#E69F00", fill="#E69F0080", data=subset(hobo.arid, Microsite=="open"), lwd=1.4) +  stat_smooth(method="lm", formula= y~poly(x,2),aes(x=arid.gradient, y=temp.var.x), color="#56B4E9", fill="#56B4E970", data=subset(hobo.arid, Microsite=="shrub"), lwd=1.4)  + ylab("Temperature variation") + xlab("Aridity Gradient")+ annotate("text", x=-4.5,y=125, label="d", size=8) 
...
m8 <- lm(log(compact)  ~  Microsite * arid.gradient, data=shrub.clim)
summary(m8)
anova(m8)
...
p8 <- ggplot(shrub.clim) + geom_jitter(aes(x=arid.gradient, y=compact), color="#56B4E9", size=3, data=subset(shrub.clim, Microsite=="shrub"))+ geom_jitter(aes(x=arid.gradient, y=compact), color="#E69F00", size=3, data=subset(shrub.clim, Microsite=="open"))+  stat_smooth(method="lm", formula= y~exp(x),aes(x=arid.gradient, y=compact), color="#56B4E9", fill="#56B4E980", data=subset(shrub.clim, Microsite=="shrub"), lwd=1.4) +  
  stat_smooth(method="lm", formula= y~exp(x),aes(x=arid.gradient, y=compact), color="#E69F00", fill="#E69F0080",data=subset(shrub.clim, Microsite=="open"), lwd=1.4)+ ylab("Soil compaction") + xlab("")+ theme_Publication() + annotate("text", x=-4.4,y=2.5, label="b", size=8) +coord_cartesian(ylim=c(0.5, 2.5))
